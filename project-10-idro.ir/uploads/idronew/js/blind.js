...
$(document).ready(function () {
    ...
    const shabnamFonts = `@font-face {font-family: Shabnam;src: url('/uploads/idronew/fonts/Shabnam-FD.woff') format('woff');font-weight: normal;font-style: normal;font-display: swap;} @font-face {font-family: Shabnam;src: url('/uploads/idronew/fonts/Shabnam-Bold-FD.woff') format('woff');font-weight: bold;font-style: normal;font-display: swap;} @font-face {font-family: Shabnam;src: url('/uploads/idronew/fonts/Shabnam-Medium-FD.woff') format('woff');font-weight: 500;font-style: normal;font-display: swap;}`;
    let sahelAdded = false;
    const sahelFonts = `@font-face {font-family: Sahel;src: url('/uploads/idronew/fonts/Sahel-FD.woff') format('woff');font-weight: normal;font-style: normal;font-display: swap;} @font-face {font-family: Sahel;src: url('/uploads/idronew/fonts/Sahel-Bold-FD.woff') format('woff');font-weight: bold;font-style: normal;font-display: swap;} @font-face {font-family: Sahel;src: url('/uploads/idronew/fonts/Sahel-SemiBold-FD.woff') format('woff');font-weight: 500;font-style: normal;font-display: swap;}`;
    ...
    disabledMenu.addEventListener('click', function (e) {
        ...
        //Mouse bigger
        if (e.target.id == 'cur1') {
            document.body.style.cursor = 'url("uploads/idronew/img/cursor-1.png"), auto';
        }
        //Mouse Reset
        ...
        //Mouse smaller
        if (e.target.id == 'cur2') {
            document.body.style.cursor = 'url("uploads/idronew/img/cursor-2.png"), auto';
        }
        //Text Color One
        if (e.target.id == 'primary-color') {
            document.querySelector('head').innerHTML += `<style>:root {--font-black: ${e.target.value};}</style>`;
        }
        //Text Color two
        if (e.target.id == 'secondary-color') {
            document.querySelector('head').innerHTML += `<style>:root {--font-white: ${e.target.value};}</style>`;
        }
