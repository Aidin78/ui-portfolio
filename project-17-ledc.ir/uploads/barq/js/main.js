...
if ($(window).width() < 992) {
  (function (e) {
    new Mmenu(
      ...
      {
        extensions: ["theme-dark", "shadow-page", "shadow-panels", "position-front", "position-right", "pagedim-black", "fx-panels-slide-100", "fx-listitems-slide"],
        navbars: [, !0],
        navbar: { add: !0, title: "منوی اصلی" },
      },
      { clone: !0 }
    );
  }).apply(this, [jQuery]);
...
document.addEventListener("DOMContentLoaded", () => {
  if (localStorage.nightMode == undefined) {
    localStorage.nightMode = false;
    }
    if (localStorage.nightMode) {
      $('.header__theme').removeClass('night-on')
      $('body').removeClass('dark-theme');
    }
    else {
      $('.header__theme').addClass('night-on')
